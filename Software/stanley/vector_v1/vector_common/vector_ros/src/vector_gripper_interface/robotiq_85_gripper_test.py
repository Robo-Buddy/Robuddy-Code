...
--------------------------------------------------------------------"""
import rospy
from vector_msgs.msg import GripperCmd, GripperStat
...
class Robotiq85GripperTest:
    ...
    def __init__(self):
        ...
        rospy.Subscriber("/vector/right_gripper/stat", GripperStat, self._update_right_gripper_stat, queue_size=10)
        self._right_gripper_pub = rospy.Publisher('/vector/right_gripper/cmd', GripperCmd, queue_size=10)               
        if (self._num_grippers == 2):
            rospy.Subscriber("/left_gripper/stat", GripperStat, self._update_left_gripper_stat, queue_size=10)
            self._left_gripper_pub = rospy.Publisher('/vector/left_gripper/stat', GripperCmd, queue_size=10)
