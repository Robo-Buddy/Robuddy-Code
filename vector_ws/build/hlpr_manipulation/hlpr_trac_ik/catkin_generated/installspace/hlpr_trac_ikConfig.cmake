...
if(NOT "include;/usr/include;/usr/include/eigen3;/opt/ros/indigo/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hlpr_trac_ik' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kristopher/vector_ws/install/${idir}'.  Ask the maintainer 'Tesca Fitzgerald <tesca.fitzgerald@gmail.com>' to fix it.")
    endif()
