...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hlpr_feature_extraction' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/athomaz/vector_ws/install/${idir}'.  Ask the maintainer 'Tesca Fitzgerald <tesca.fitzgerald@cc.gatech.edu>' to fix it.")
    endif()
