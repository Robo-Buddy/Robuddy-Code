...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hlpr_manipulation_actions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/athomaz/vector_ws/src/hlpr_manipulation/hlpr_manipulation_actions/${idir}'.  Ask the maintainer 'David Kent <dekent@gatech.edu>' to fix it.")
    endif()
