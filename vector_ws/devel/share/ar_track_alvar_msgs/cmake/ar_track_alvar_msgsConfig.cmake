...
if("TRUE" STREQUAL "TRUE")
  set(ar_track_alvar_msgs_SOURCE_PREFIX /home/athomaz/vector_ws/src/ ar_track_alvar_msgs)
  set(ar_track_alvar_msgs_DEVEL_PREFIX /home/athomaz/vector_ws/devel)
  ...
  set(ar_track_alvar_msgs_INSTALL_PREFIX /home/athomaz/vector_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ar_track_alvar_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Scott Niekum <sniekum@cs.umass.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ar_track_alvar_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/athomaz/vector_ws/src/ ar_track_alvar_msgs/${idir}'.  Ask the maintainer 'Scott Niekum <sniekum@cs.umass.edu>' to fix it.")
    endif()
...
set(ar_track_alvar_msgs_EXPORTED_TARGETS "ar_track_alvar_msgs_generate_messages_cpp;ar_track_alvar_msgs_generate_messages_eus;ar_track_alvar_msgs_generate_messages_lisp;ar_track_alvar_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ar_track_alvar_msgs_dep}_FOUND)
      find_package(${ar_track_alvar_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ar_track_alvar_msgs_dep} REQUIRED ${depend_list})
  endif()
