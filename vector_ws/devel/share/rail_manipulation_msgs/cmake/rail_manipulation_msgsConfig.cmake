...
if("TRUE" STREQUAL "TRUE")
  set(rail_manipulation_msgs_SOURCE_PREFIX /home/kristopher/vector_ws/src/rail_manipulation_msgs)
  set(rail_manipulation_msgs_DEVEL_PREFIX /home/kristopher/vector_ws/devel)
  ...
  set(rail_manipulation_msgs_INSTALL_PREFIX /home/kristopher/vector_ws/install)
...
if(NOT "/home/kristopher/vector_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rail_manipulation_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kristopher/vector_ws/src/rail_manipulation_msgs/${idir}'.  Ask the maintainer 'David Kent <dekent@gatech.edu>, Russell Toris <russell.toris@gmail.com>' to fix it.")
    endif()
...
set(rail_manipulation_msgs_EXPORTED_TARGETS "rail_manipulation_msgs_generate_messages_cpp;rail_manipulation_msgs_generate_messages_eus;rail_manipulation_msgs_generate_messages_lisp;rail_manipulation_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rail_manipulation_msgs_dep}_FOUND)
      find_package(${rail_manipulation_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rail_manipulation_msgs_dep} REQUIRED ${depend_list})
  endif()
