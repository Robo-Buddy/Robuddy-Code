...
(cl:defmethod cl:initialize-instance :after ((m <ClusterIndex>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ClusterIndex)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hlpr_perception_msgs-msg:<ClusterIndex> is deprecated: use hlpr_perception_msgs-msg:ClusterIndex instead.")))

(cl:ensure-generic-function 'indices-val :lambda-list '(m))
(cl:defmethod indices-val ((m <ClusterIndex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hlpr_perception_msgs-msg:indices-val is deprecated.  Use hlpr_perception_msgs-msg:indices instead.")
  (indices m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ClusterIndex>)))
  ...
  "hlpr_perception_msgs/ClusterIndex")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ClusterIndex)))
  "Returns string type for a message object of type 'ClusterIndex"
  "hlpr_perception_msgs/ClusterIndex")
