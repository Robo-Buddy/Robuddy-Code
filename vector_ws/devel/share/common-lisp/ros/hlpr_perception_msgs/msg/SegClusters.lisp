...
;//! \htmlinclude SegClusters.msg.html

(cl:defclass <SegClusters> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
   ...
   (cluster_ids
    :reader cluster_ids
    :initarg :cluster_ids
    :type (cl:vector hlpr_perception_msgs-msg:ClusterIndex)
   :initform (cl:make-array 0 :element-type 'hlpr_perception_msgs-msg:ClusterIndex :initial-element (cl:make-instance 'hlpr_perception_msgs-msg:ClusterIndex))))
)

(cl:defclass SegClusters (<SegClusters>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <SegClusters>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'SegClusters)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hlpr_perception_msgs-msg:<SegClusters> is deprecated: use hlpr_perception_msgs-msg:SegClusters instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <SegClusters>))
...
(cl:defmethod clusters-val ((m <SegClusters>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hlpr_perception_msgs-msg:clusters-val is deprecated.  Use hlpr_perception_msgs-msg:clusters instead.")
  (clusters m))

(cl:ensure-generic-function 'normals-val :lambda-list '(m))
(cl:defmethod normals-val ((m <SegClusters>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hlpr_perception_msgs-msg:normals-val is deprecated.  Use hlpr_perception_msgs-msg:normals instead.")
  (normals m))

(cl:ensure-generic-function 'plane-val :lambda-list '(m))
(cl:defmethod plane-val ((m <SegClusters>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hlpr_perception_msgs-msg:plane-val is deprecated.  Use hlpr_perception_msgs-msg:plane instead.")
  (plane m))

(cl:ensure-generic-function 'cluster_ids-val :lambda-list '(m))
(cl:defmethod cluster_ids-val ((m <SegClusters>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hlpr_perception_msgs-msg:cluster_ids-val is deprecated.  Use hlpr_perception_msgs-msg:cluster_ids instead.")
  (cluster_ids m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SegClusters>) ostream)
  "Serializes a message object of type '<SegClusters>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SegClusters>) istream)
  "Deserializes a message object of type '<SegClusters>"
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SegClusters>))
