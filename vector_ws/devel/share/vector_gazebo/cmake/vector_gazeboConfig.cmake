...
if("TRUE" STREQUAL "TRUE")
  set(vector_gazebo_SOURCE_PREFIX /home/athomaz/vector_ws/src/vector_v1/vector_gazebo)
  set(vector_gazebo_DEVEL_PREFIX /home/athomaz/vector_ws/devel)
  ...
  set(vector_gazebo_INSTALL_PREFIX /home/athomaz/vector_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vector_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/athomaz/vector_ws/src/vector_v1/vector_gazebo/${idir}'.  Ask the maintainer 'Patrick Hussey <dev@stanleyinnovation.com>' to fix it.")
    endif()
