...
if("TRUE" STREQUAL "TRUE")
  set(task3_SOURCE_PREFIX /home/athomaz/vector_ws/src/HBlqr/task3)
  set(task3_DEVEL_PREFIX /home/athomaz/vector_ws/devel)
  set(task3_INSTALL_PREFIX "")
  set(task3_PREFIX ${task3_DEVEL_PREFIX})
else()
  set(task3_SOURCE_PREFIX "")
  set(task3_DEVEL_PREFIX "")
  set(task3_INSTALL_PREFIX /home/athomaz/vector_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'task3' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Vivian Chu <vchu@gatech.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'task3' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/athomaz/vector_ws/src/HBlqr/task3/${idir}'.  Ask the maintainer 'Vivian Chu <vchu@gatech.edu>' to fix it.")
    endif()
...
set(task3_EXPORTED_TARGETS "task3_generate_messages_cpp;task3_generate_messages_eus;task3_generate_messages_lisp;task3_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${task3_dep}_FOUND)
      find_package(${task3_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${task3_dep} REQUIRED ${depend_list})
  endif()
...
set(pkg_cfg_extras "task3-msg-extras.cmake")
