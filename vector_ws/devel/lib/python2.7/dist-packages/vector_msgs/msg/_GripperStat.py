...
"""autogenerated by genpy from vector_msgs/GripperStat.msg. Do not edit."""
import sys
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_5B3f.pack(_x.is_ready, _x.is_reset, _x.is_moving, _x.obj_detected, _x.fault_status, _x.position, _x.requested_position, _x.current))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.is_ready, _x.is_reset, _x.is_moving, _x.obj_detected, _x.fault_status, _x.position, _x.requested_position, _x.current,) = _struct_5B3f.unpack(str[start:end])
