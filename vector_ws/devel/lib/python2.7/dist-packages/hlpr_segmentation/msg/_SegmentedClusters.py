...
"""autogenerated by genpy from hlpr_segmentation/SegmentedClusters.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import hlpr_segmentation.msg
import sensor_msgs.msg
import std_msgs.msg

class SegmentedClusters(genpy.Message):
  _md5sum = "38727b412bf02284a892b2f6c9e62bcd"
  _type = "hlpr_segmentation/SegmentedClusters"
...
int32 data"""
  ...
  _slot_types = ['std_msgs/Header','sensor_msgs/PointCloud2[]','sensor_msgs/PointCloud2[]','std_msgs/Float32MultiArray','hlpr_segmentation/ClusterIndex[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.cluster_ids = []
      for i in range(0, length):
        val1 = hlpr_segmentation.msg.ClusterIndex()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.indices = []
