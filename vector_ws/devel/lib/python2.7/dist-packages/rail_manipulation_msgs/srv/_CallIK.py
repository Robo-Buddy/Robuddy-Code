...
"""autogenerated by genpy from rail_manipulation_msgs/CallIKRequest.msg. Do not edit."""
import sys
...
class CallIKRequest(genpy.Message):
  _md5sum = "3f8930d968a3e84d471dff917bb1cdae"
  _type = "rail_manipulation_msgs/CallIKRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CallIKRequest, self).__init__(*args, **kwds)
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from rail_manipulation_msgs/CallIKResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class CallIKResponse(genpy.Message):
  _md5sum = "2ce36d247dfbec462f247fb79bee8da9"
  _type = "rail_manipulation_msgs/CallIKResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """float64[] jointPositions
bool success

"""
  __slots__ = ['jointPositions','success']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CallIKResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.jointPositions))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.jointPositions = struct.unpack(pattern, str[start:end])
      start = end
      end += 1
...
class CallIK(object):
  _type          = 'rail_manipulation_msgs/CallIK'
  _md5sum = '538966e8ee9bb323633dfda1747087d9'
  _request_class  = CallIKRequest
  _response_class = CallIKResponse
