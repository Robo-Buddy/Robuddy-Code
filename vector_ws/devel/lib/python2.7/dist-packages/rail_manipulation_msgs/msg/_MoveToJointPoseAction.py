...
"""autogenerated by genpy from rail_manipulation_msgs/MoveToJointPoseAction.msg. Do not edit."""
import sys
...
class MoveToJointPoseAction(genpy.Message):
  _md5sum = "609794e86acff51b2d6a086e2ba9ce0c"
  _type = "rail_manipulation_msgs/MoveToJointPoseAction"
...
"""
  ...
  _slot_types = ['rail_manipulation_msgs/MoveToJointPoseActionGoal','rail_manipulation_msgs/MoveToJointPoseActionResult','rail_manipulation_msgs/MoveToJointPoseActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveToJointPoseAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = rail_manipulation_msgs.msg.MoveToJointPoseActionGoal()
      if self.action_result is None:
        self.action_result = rail_manipulation_msgs.msg.MoveToJointPoseActionResult()
      if self.action_feedback is None:
        self.action_feedback = rail_manipulation_msgs.msg.MoveToJointPoseActionFeedback()
    else:
      self.action_goal = rail_manipulation_msgs.msg.MoveToJointPoseActionGoal()
      self.action_result = rail_manipulation_msgs.msg.MoveToJointPoseActionResult()
      self.action_feedback = rail_manipulation_msgs.msg.MoveToJointPoseActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.joints)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.joints))
      _x = self
      buff.write(_struct_f3I.pack(_x.action_goal.goal.planningTime, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_goal.goal.joints = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 16
      (_x.action_goal.goal.planningTime, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.action_goal.goal.joints.tostring())
      _x = self
      buff.write(_struct_f3I.pack(_x.action_goal.goal.planningTime, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      _x = self.action_result.header.frame_id
      length = len(_x)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_goal.goal.joints = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      _x = self
      start = end
      end += 16
      (_x.action_goal.goal.planningTime, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_f3I.unpack(str[start:end])
