...
class SegmentedObject(genpy.Message):
  _md5sum = "d1b271aa4d3c6ea9d3db1534e1c96ccf"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B3I.pack(_x.point_cloud.is_dense, _x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs))
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_13dB.pack(_x.centroid.x, _x.centroid.y, _x.centroid.z, _x.center.x, _x.center.y, _x.center.z, _x.width, _x.depth, _x.height, _x.orientation.x, _x.orientation.y, _x.orientation.z, _x.orientation.w, _x.recognized))
      _x = self.name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.point_cloud.is_dense, _x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
      ...
      (_x.centroid.x, _x.centroid.y, _x.centroid.z, _x.center.x, _x.center.y, _x.center.z, _x.width, _x.depth, _x.height, _x.orientation.x, _x.orientation.y, _x.orientation.z, _x.orientation.w, _x.recognized,) = _struct_13dB.unpack(str[start:end])
