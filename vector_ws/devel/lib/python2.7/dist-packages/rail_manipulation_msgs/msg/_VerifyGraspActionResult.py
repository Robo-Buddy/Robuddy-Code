...
"""autogenerated by genpy from rail_manipulation_msgs/VerifyGraspActionResult.msg. Do not edit."""
import sys
...
class VerifyGraspActionResult(genpy.Message):
  _md5sum = "b46dc38d8e18be50f2ad5b922709638f"
  _type = "rail_manipulation_msgs/VerifyGraspActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rail_manipulation_msgs/VerifyGraspResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(VerifyGraspActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = rail_manipulation_msgs.msg.VerifyGraspResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rail_manipulation_msgs.msg.VerifyGraspResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2B.pack(_x.result.success, _x.result.grasping))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.success, _x.result.grasping,) = _struct_2B.unpack(str[start:end])
      self.result.success = bool(self.result.success)
      self.result.grasping = bool(self.result.grasping)
      return self
