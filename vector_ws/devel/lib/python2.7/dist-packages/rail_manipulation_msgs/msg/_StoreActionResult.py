...
"""autogenerated by genpy from rail_manipulation_msgs/StoreActionResult.msg. Do not edit."""
import sys
...
class StoreActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "rail_manipulation_msgs/StoreActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rail_manipulation_msgs/StoreResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StoreActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = rail_manipulation_msgs.msg.StoreResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rail_manipulation_msgs.msg.StoreResult()
