...
"""autogenerated by genpy from rail_manipulation_msgs/MoveToPoseAction.msg. Do not edit."""
import sys
...
class MoveToPoseAction(genpy.Message):
  _md5sum = "df09b099db76efe90d7823079372ca9b"
  _type = "rail_manipulation_msgs/MoveToPoseAction"
...
"""
  ...
  _slot_types = ['rail_manipulation_msgs/MoveToPoseActionGoal','rail_manipulation_msgs/MoveToPoseActionResult','rail_manipulation_msgs/MoveToPoseActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveToPoseAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = rail_manipulation_msgs.msg.MoveToPoseActionGoal()
      if self.action_result is None:
        self.action_result = rail_manipulation_msgs.msg.MoveToPoseActionResult()
      if self.action_feedback is None:
        self.action_feedback = rail_manipulation_msgs.msg.MoveToPoseActionFeedback()
    else:
      self.action_goal = rail_manipulation_msgs.msg.MoveToPoseActionGoal()
      self.action_result = rail_manipulation_msgs.msg.MoveToPoseActionResult()
      self.action_feedback = rail_manipulation_msgs.msg.MoveToPoseActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7dfd3I.pack(_x.action_goal.goal.pose.pose.position.x, _x.action_goal.goal.pose.pose.position.y, _x.action_goal.goal.pose.pose.position.z, _x.action_goal.goal.pose.pose.orientation.x, _x.action_goal.goal.pose.pose.orientation.y, _x.action_goal.goal.pose.pose.orientation.z, _x.action_goal.goal.pose.pose.orientation.w, _x.action_goal.goal.planningTime, _x.action_goal.goal.jointStateDifference, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2B3I.pack(_x.action_result.result.ikSuccess, _x.action_result.result.success, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.ikSuccess, _x.action_result.result.success, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_2B3I.unpack(str[start:end])
      self.action_result.result.ikSuccess = bool(self.action_result.result.ikSuccess)
...
_struct_7dfd3I = struct.Struct("<7dfd3I")
