...
"""autogenerated by genpy from rail_manipulation_msgs/StoreActionFeedback.msg. Do not edit."""
import sys
...
class StoreActionFeedback(genpy.Message):
  _md5sum = "c174906940145c775f10875f0919664b"
  _type = "rail_manipulation_msgs/StoreActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rail_manipulation_msgs/StoreFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StoreActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = rail_manipulation_msgs.msg.StoreFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = rail_manipulation_msgs.msg.StoreFeedback()
