...
"""autogenerated by genpy from rail_manipulation_msgs/PickupActionResult.msg. Do not edit."""
import sys
...
class PickupActionResult(genpy.Message):
  _md5sum = "13944c07af31a802024e2fa5f169a4b3"
  _type = "rail_manipulation_msgs/PickupActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rail_manipulation_msgs/PickupResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = rail_manipulation_msgs.msg.PickupResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rail_manipulation_msgs.msg.PickupResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2B.pack(_x.result.executionSuccess, _x.result.success))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.executionSuccess, _x.result.success,) = _struct_2B.unpack(str[start:end])
      self.result.executionSuccess = bool(self.result.executionSuccess)
