...
"""autogenerated by genpy from rail_manipulation_msgs/PickupAction.msg. Do not edit."""
import sys
...
class PickupAction(genpy.Message):
  _md5sum = "ddf80a3abc63215a9969a231a2737f17"
  _type = "rail_manipulation_msgs/PickupAction"
...
"""
  ...
  _slot_types = ['rail_manipulation_msgs/PickupActionGoal','rail_manipulation_msgs/PickupActionResult','rail_manipulation_msgs/PickupActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = rail_manipulation_msgs.msg.PickupActionGoal()
      if self.action_result is None:
        self.action_result = rail_manipulation_msgs.msg.PickupActionResult()
      if self.action_feedback is None:
        self.action_feedback = rail_manipulation_msgs.msg.PickupActionFeedback()
    else:
      self.action_goal = rail_manipulation_msgs.msg.PickupActionGoal()
      self.action_result = rail_manipulation_msgs.msg.PickupActionResult()
      self.action_feedback = rail_manipulation_msgs.msg.PickupActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2B3I.pack(_x.action_result.result.executionSuccess, _x.action_result.result.success, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.pose.pose.position.x, _x.action_goal.goal.pose.pose.position.y, _x.action_goal.goal.pose.pose.position.z, _x.action_goal.goal.pose.pose.orientation.x, _x.action_goal.goal.pose.pose.orientation.y, _x.action_goal.goal.pose.pose.orientation.z, _x.action_goal.goal.pose.pose.orientation.w, _x.action_goal.goal.lift, _x.action_goal.goal.verify, _x.action_goal.goal.attachObject, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_7d3B3I.unpack(str[start:end])
      self.action_goal.goal.lift = bool(self.action_goal.goal.lift)
      self.action_goal.goal.verify = bool(self.action_goal.goal.verify)
      self.action_goal.goal.attachObject = bool(self.action_goal.goal.attachObject)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.executionSuccess, _x.action_result.result.success, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_2B3I.unpack(str[start:end])
      self.action_result.result.executionSuccess = bool(self.action_result.result.executionSuccess)
...
_struct_7d3B3I = struct.Struct("<7d3B3I")
