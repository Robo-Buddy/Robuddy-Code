...
"""autogenerated by genpy from rail_manipulation_msgs/LiftActionResult.msg. Do not edit."""
import sys
...
class LiftActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "rail_manipulation_msgs/LiftActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rail_manipulation_msgs/LiftResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LiftActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = rail_manipulation_msgs.msg.LiftResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rail_manipulation_msgs.msg.LiftResult()
