...
"""autogenerated by genpy from rail_manipulation_msgs/SegmentedObjectList.msg. Do not edit."""
import sys
...
class SegmentedObjectList(genpy.Message):
  _md5sum = "e57a04968eb7dd0f5a137f0c79a9d864"
  _type = "rail_manipulation_msgs/SegmentedObjectList"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """Header header              # Contains timestamp information for the most recent update to the object list
...
float32 a
"""
  __slots__ = ['header','cleared','objects']
  _slot_types = ['std_msgs/Header','bool','rail_manipulation_msgs/SegmentedObject[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SegmentedObjectList, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.objects:
        ...
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
        _x = val1
        buff.write(_struct_3d.pack(_x.width, _x.depth, _x.height))
        _v9 = val1.orientation
        _x = _v9
        buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_struct_B.pack(val1.recognized))
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        if python3:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        _x = val1
        buff.write(_struct_Id.pack(_x.model_id, _x.confidence))
        ...
        _x = _v24
        buff.write(_struct_2i.pack(_x.secs, _x.nsecs))
        buff.write(_struct_B.pack(_v16.frame_locked))
        ...
        if python3:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_struct_B.pack(_v16.mesh_use_embedded_materials))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v25.is_dense,) = _struct_B.unpack(str[start:end])
        ...
        (_x.width, _x.depth, _x.height,) = _struct_3d.unpack(str[start:end])
        ...
        (val1.recognized,) = _struct_B.unpack(str[start:end])
        ...
        (_x.model_id, _x.confidence,) = _struct_Id.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.grasps = []
        ...
        (_v40.frame_locked,) = _struct_B.unpack(str[start:end])
        ...
        (_v40.mesh_use_embedded_materials,) = _struct_B.unpack(str[start:end])
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.objects:
        ...
        _x = _v72
        buff.write(_struct_2i.pack(_x.secs, _x.nsecs))
        buff.write(_struct_B.pack(_v64.frame_locked))
        ...
        if python3:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_struct_B.pack(_v64.mesh_use_embedded_materials))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v88.frame_locked,) = _struct_B.unpack(str[start:end])
        ...
        (_v88.mesh_use_embedded_materials,) = _struct_B.unpack(str[start:end])
