...
"""autogenerated by genpy from rail_manipulation_msgs/LiftActionFeedback.msg. Do not edit."""
import sys
...
class LiftActionFeedback(genpy.Message):
  _md5sum = "c174906940145c775f10875f0919664b"
  _type = "rail_manipulation_msgs/LiftActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rail_manipulation_msgs/LiftFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LiftActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = rail_manipulation_msgs.msg.LiftFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = rail_manipulation_msgs.msg.LiftFeedback()
