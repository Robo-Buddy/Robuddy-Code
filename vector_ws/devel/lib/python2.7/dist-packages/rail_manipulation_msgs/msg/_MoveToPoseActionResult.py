...
"""autogenerated by genpy from rail_manipulation_msgs/MoveToPoseActionResult.msg. Do not edit."""
import sys
...
class MoveToPoseActionResult(genpy.Message):
  _md5sum = "be7d42549c086d17d8630473dc4ab8fd"
  _type = "rail_manipulation_msgs/MoveToPoseActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rail_manipulation_msgs/MoveToPoseResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveToPoseActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = rail_manipulation_msgs.msg.MoveToPoseResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rail_manipulation_msgs.msg.MoveToPoseResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2B.pack(_x.result.ikSuccess, _x.result.success))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.ikSuccess, _x.result.success,) = _struct_2B.unpack(str[start:end])
      self.result.ikSuccess = bool(self.result.ikSuccess)
