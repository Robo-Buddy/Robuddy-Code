...
"""autogenerated by genpy from rail_manipulation_msgs/PrimitiveAction.msg. Do not edit."""
import sys
...
class PrimitiveAction(genpy.Message):
  _md5sum = "230c98ce074c5616b5f531869e9f728e"
  _type = "rail_manipulation_msgs/PrimitiveAction"
...
"""
  ...
  _slot_types = ['rail_manipulation_msgs/PrimitiveActionGoal','rail_manipulation_msgs/PrimitiveActionResult','rail_manipulation_msgs/PrimitiveActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PrimitiveAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = rail_manipulation_msgs.msg.PrimitiveActionGoal()
      if self.action_result is None:
        self.action_result = rail_manipulation_msgs.msg.PrimitiveActionResult()
      if self.action_feedback is None:
        self.action_feedback = rail_manipulation_msgs.msg.PrimitiveActionFeedback()
    else:
      self.action_goal = rail_manipulation_msgs.msg.PrimitiveActionGoal()
      self.action_result = rail_manipulation_msgs.msg.PrimitiveActionResult()
      self.action_feedback = rail_manipulation_msgs.msg.PrimitiveActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2Bd3I.pack(_x.action_goal.goal.primitive_type, _x.action_goal.goal.axis, _x.action_goal.goal.distance, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_d3I.pack(_x.action_result.result.completion, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.primitive_type, _x.action_goal.goal.axis, _x.action_goal.goal.distance, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_2Bd3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.completion, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
