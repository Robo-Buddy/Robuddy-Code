...
"""autogenerated by genpy from wpi_jaco_msgs/HomeArmAction.msg. Do not edit."""
import sys
...
class HomeArmAction(genpy.Message):
  _md5sum = "4949ebff8e2a96434fb0a1cc144d935f"
  _type = "wpi_jaco_msgs/HomeArmAction"
...
"""
  ...
  _slot_types = ['wpi_jaco_msgs/HomeArmActionGoal','wpi_jaco_msgs/HomeArmActionResult','wpi_jaco_msgs/HomeArmActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(HomeArmAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = wpi_jaco_msgs.msg.HomeArmActionGoal()
      if self.action_result is None:
        self.action_result = wpi_jaco_msgs.msg.HomeArmActionResult()
      if self.action_feedback is None:
        self.action_feedback = wpi_jaco_msgs.msg.HomeArmActionFeedback()
    else:
      self.action_goal = wpi_jaco_msgs.msg.HomeArmActionGoal()
      self.action_result = wpi_jaco_msgs.msg.HomeArmActionResult()
      self.action_feedback = wpi_jaco_msgs.msg.HomeArmActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_5B.pack(_x.action_goal.goal.retract, _x.action_goal.goal.retractPosition.position, _x.action_goal.goal.retractPosition.armCommand, _x.action_goal.goal.retractPosition.fingerCommand, _x.action_goal.goal.retractPosition.repeat))
      length = len(self.action_goal.goal.retractPosition.joints)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.retractPosition.joints))
      length = len(self.action_goal.goal.retractPosition.fingers)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.retractPosition.fingers))
      _x = self
      buff.write(_struct_h3I.pack(_x.action_goal.goal.numAttempts, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.retract, _x.action_goal.goal.retractPosition.position, _x.action_goal.goal.retractPosition.armCommand, _x.action_goal.goal.retractPosition.fingerCommand, _x.action_goal.goal.retractPosition.repeat,) = _struct_5B.unpack(str[start:end])
      self.action_goal.goal.retract = bool(self.action_goal.goal.retract)
      self.action_goal.goal.retractPosition.position = bool(self.action_goal.goal.retractPosition.position)
      self.action_goal.goal.retractPosition.armCommand = bool(self.action_goal.goal.retractPosition.armCommand)
      self.action_goal.goal.retractPosition.fingerCommand = bool(self.action_goal.goal.retractPosition.fingerCommand)
      self.action_goal.goal.retractPosition.repeat = bool(self.action_goal.goal.retractPosition.repeat)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.action_goal.goal.retractPosition.joints = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.action_goal.goal.retractPosition.fingers = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 14
      (_x.action_goal.goal.numAttempts, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_h3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.action_goal.goal.retractPosition.joints.tostring())
      length = len(self.action_goal.goal.retractPosition.fingers)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.action_goal.goal.retractPosition.fingers.tostring())
      _x = self
      buff.write(_struct_h3I.pack(_x.action_goal.goal.numAttempts, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      _x = self.action_result.header.frame_id
      length = len(_x)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_goal.goal.retractPosition.joints = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.action_goal.goal.retractPosition.fingers = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      _x = self
      start = end
      end += 14
      (_x.action_goal.goal.numAttempts, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_h3I.unpack(str[start:end])
