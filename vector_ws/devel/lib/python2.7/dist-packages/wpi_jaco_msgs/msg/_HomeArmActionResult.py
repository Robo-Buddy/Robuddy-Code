...
"""autogenerated by genpy from wpi_jaco_msgs/HomeArmActionResult.msg. Do not edit."""
import sys
...
class HomeArmActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "wpi_jaco_msgs/HomeArmActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','wpi_jaco_msgs/HomeArmResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(HomeArmActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = wpi_jaco_msgs.msg.HomeArmResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = wpi_jaco_msgs.msg.HomeArmResult()
