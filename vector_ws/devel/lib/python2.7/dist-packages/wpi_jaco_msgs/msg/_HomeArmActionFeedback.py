...
"""autogenerated by genpy from wpi_jaco_msgs/HomeArmActionFeedback.msg. Do not edit."""
import sys
...
class HomeArmActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "wpi_jaco_msgs/HomeArmActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','wpi_jaco_msgs/HomeArmFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(HomeArmActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = wpi_jaco_msgs.msg.HomeArmFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = wpi_jaco_msgs.msg.HomeArmFeedback()
