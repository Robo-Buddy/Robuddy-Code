// Generated by gencpp from file vector_msgs/Dynamics.msg
// DO NOT EDIT!


#ifndef VECTOR_MSGS_MESSAGE_DYNAMICS_H
#define VECTOR_MSGS_MESSAGE_DYNAMICS_H
...
struct Dynamics_
{
  ...
  typedef boost::shared_ptr< ::vector_msgs::Dynamics_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::vector_msgs::Dynamics_<ContainerAllocator> const> ConstPtr;

}; // struct Dynamics_

typedef ::vector_msgs::Dynamics_<std::allocator<void> > Dynamics;

typedef boost::shared_ptr< ::vector_msgs::Dynamics > DynamicsPtr;
typedef boost::shared_ptr< ::vector_msgs::Dynamics const> DynamicsConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::vector_msgs::Dynamics_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::vector_msgs::Dynamics_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::vector_msgs::Dynamics_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::vector_msgs::Dynamics_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::vector_msgs::Dynamics_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::vector_msgs::Dynamics_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::vector_msgs::Dynamics_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::vector_msgs::Dynamics_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::vector_msgs::Dynamics_<ContainerAllocator> >
{
  ...
  static const char* value(const ::vector_msgs::Dynamics_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xdd32431766932850ULL;
  static const uint64_t static_value2 = 0xde2062a4263871b4ULL;
};

template<class ContainerAllocator>
struct DataType< ::vector_msgs::Dynamics_<ContainerAllocator> >
{
  static const char* value()
  {
    return "vector_msgs/Dynamics";
  }
...
template<class ContainerAllocator>
struct Definition< ::vector_msgs::Dynamics_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::vector_msgs::Dynamics_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::vector_msgs::Dynamics_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::vector_msgs::Dynamics_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // VECTOR_MSGS_MESSAGE_DYNAMICS_H
