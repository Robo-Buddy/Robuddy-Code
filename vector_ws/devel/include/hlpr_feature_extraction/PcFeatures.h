// Generated by gencpp from file hlpr_feature_extraction/PcFeatures.msg
// DO NOT EDIT!


#ifndef HLPR_FEATURE_EXTRACTION_MESSAGE_PCFEATURES_H
#define HLPR_FEATURE_EXTRACTION_MESSAGE_PCFEATURES_H
...
struct PcFeatures_
{
  ...
  typedef boost::shared_ptr< ::hlpr_feature_extraction::PcFeatures_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::hlpr_feature_extraction::PcFeatures_<ContainerAllocator> const> ConstPtr;

}; // struct PcFeatures_

typedef ::hlpr_feature_extraction::PcFeatures_<std::allocator<void> > PcFeatures;

typedef boost::shared_ptr< ::hlpr_feature_extraction::PcFeatures > PcFeaturesPtr;
typedef boost::shared_ptr< ::hlpr_feature_extraction::PcFeatures const> PcFeaturesConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::hlpr_feature_extraction::PcFeatures_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::hlpr_feature_extraction::PcFeatures_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::hlpr_feature_extraction::PcFeatures_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::hlpr_feature_extraction::PcFeatures_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::hlpr_feature_extraction::PcFeatures_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::hlpr_feature_extraction::PcFeatures_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::hlpr_feature_extraction::PcFeatures_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::hlpr_feature_extraction::PcFeatures_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::hlpr_feature_extraction::PcFeatures_<ContainerAllocator> >
{
  ...
  static const char* value(const ::hlpr_feature_extraction::PcFeatures_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x623fac7b3275a816ULL;
  static const uint64_t static_value2 = 0x43e666d8b500f34fULL;
};

template<class ContainerAllocator>
struct DataType< ::hlpr_feature_extraction::PcFeatures_<ContainerAllocator> >
{
  static const char* value()
  {
    return "hlpr_feature_extraction/PcFeatures";
  }
...
template<class ContainerAllocator>
struct Definition< ::hlpr_feature_extraction::PcFeatures_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::hlpr_feature_extraction::PcFeatures_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::hlpr_feature_extraction::PcFeatures_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::hlpr_feature_extraction::PcFeatures_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // HLPR_FEATURE_EXTRACTION_MESSAGE_PCFEATURES_H
