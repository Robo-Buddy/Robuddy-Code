  ...
  public:
    ...
    public:
      ParamDescription(std::string name, std::string type, uint32_t level, 
          std::string description, std::string edit_method, T laserscan_virtualizerConfig::* f) :
      ...
      virtual void clamp(laserscan_virtualizerConfig &config, const laserscan_virtualizerConfig &max, const laserscan_virtualizerConfig &min) const
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const laserscan_virtualizerConfig &config1, const laserscan_virtualizerConfig &config2) const
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, laserscan_virtualizerConfig &config) const
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const laserscan_virtualizerConfig &config) const
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, laserscan_virtualizerConfig &config) const
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const laserscan_virtualizerConfig &config) const
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const laserscan_virtualizerConfig &config, boost::any &val) const
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, laserscan_virtualizerConfig &top) const
      {
        PT* config = boost::any_cast<PT*>(cfg);
